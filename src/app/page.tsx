...
export default function Home() {
  ...
  const services = [
    { icon: '✂️', title: 'Sanatçı Tıraşı', desc: 'TV ve sahne deneyimiyle kazanılan tekniklerle sadece size özel, karakterinizi ortaya çıkaran modern saç kesimi.', tag: 'Popüler' },
    { icon: '📐', title: 'Anatomik Kesim', desc: 'Kafa tası yapınıza ve yüz hatlarınıza uygun, dökülme yönlerine göre tasarlanmış bireysel kesim anlayışı.', tag: null },
    { icon: '🧔', title: 'Sakal & Bıyık', desc: 'Modern tekniklerle yüzünüze en uygun sakal ve bıyık şekillendirmesi. Tıraş sonrası bakım dahil.', tag: null },
    { icon: '💆', title: 'Özel Styling', desc: 'Daveti, etkinliği veya çekimi için saç şekillendirme ve profesyonel ürünlerle cilt bakım hizmetleri.', tag: 'Yeni' },
  ];
    ...
    <div className={styles.container}>
      ...
      <nav className={`${styles.navbar} ${scrolled ? styles.navbarScrolled : ''}`}>
        <div className={styles.logo}>
          ...
          <span className={styles.logoSubtitle}>Hair & Styling Artist</span>
        </div>
      ...
      <header className={styles.hero}>
        ...
        <div className={styles.heroContent}>
          ...
          <h1 className={styles.heroTitle}>
            <span className={styles.heroTitleLine1}>Erbil</span>
            <span className={styles.heroTitleLine2}>Kızıltan</span>
          </h1>

          <p className={styles.heroSubtitle}>Hair &amp; Styling Artist</p>

          <p className={styles.heroDescription}>
            Ünlülerden sahneye, ekrandan sokağa —<br />her ortamda premium imaj.
          </p>
      ...
      >
        <div className={styles.sectionHeader}>
          ...
          <h2 className={styles.sectionTitle}>Sanatçı Dokunuşu,<br />Her Kesimde</h2>
        </div>
        ...
        <div className={styles.bookingInner}>
          ...
          <div className={styles.bookingInfo}>
            ...
            <p className={styles.bookingSubtitle}>
              Sağdan uygun gün ve saati seçerek dakikalar içinde randevunuzu oluşturun.
            </p>
            ...
            <div className={styles.bookingPerks}>
              {[
                ...
                { icon: '📅', title: 'Esnek Saatler', desc: 'Her gün 09:00\'dan itibaren açık.' },
                { icon: '✂️', title: 'Uzman Ellerde', desc: 'TV ve sahne deneyimli sanatçı tıraşı.' },
          ...
          <div className={styles.bookingCalendarWrap}>
            <div className={styles.bookingCalendarCard}>
              {/* Header bar — makes it look native */}
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.footerBottom}>
          <p className={styles.copyright}>
            © {new Date().getFullYear()} Kuaför Erbil Kızıltan. Tüm hakları saklıdır.
          </p>
          <div className={styles.footerBottomLinks}>
            <span className={styles.footerRating}>★★★★★ 5.0 Google</span>
          </div>
        </div>
      </footer>
    </div>
