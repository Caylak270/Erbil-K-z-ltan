        ...
        <div className={styles.contactGrid}>
          <div className={styles.contactInfo}>
            {[
              ...
              { icon: '📸', title: 'Instagram', href: 'https://www.instagram.com/erbil.kiziltan/', link: '@erbil.kiziltan', external: true },
            ].map((card) => (
      ...
      <footer className={styles.footer}>
        <div className={styles.footerTop}>
          <div className={styles.footerBrand}>
            ...
            <a
              href="https://www.instagram.com/erbil.kiziltan/"
              target="_blank"
        ...
        <div className={styles.footerLinks}>
          ...
          <div className={styles.footerCol}>
            <h5>Hızlı Erişim</h5>
            <a href="https://www.instagram.com/erbil.kiziltan/" target="_blank" rel="noopener noreferrer">Instagram</a>
